...
const renderComments = (comments) => comments.map(createCommentMarkup).join(`\n`);

const createFilmDetailsPopupMarkup = (filmData) => {
  const {
    title,
    originalTitle,
    rating,
      ...
      <form class="film-details__inner" action="" method="get">
        <div class="form-details__top-container">
          ...
          <section class="film-details__controls">
            ...
            <input type="checkbox" class="film-details__control-input visually-hidden" id="watched" name="watched" ${isWathced ? `checked` : ``}>
...
export {createFilmDetailsPopupMarkup};
